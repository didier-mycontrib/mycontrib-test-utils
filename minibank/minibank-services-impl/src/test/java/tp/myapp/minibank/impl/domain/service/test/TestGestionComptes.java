...
public class TestGestionComptes extends MiniBankAbstractServiceSpringTest{
	...
	public void testGetOperationsOfCompte(){
		try {
			...
			for(Operation op:listeOp){
				System.out.println("\t"+op.toString() + (op instanceof _Operation ? " - optimized for inheritance" : ""));
			}
